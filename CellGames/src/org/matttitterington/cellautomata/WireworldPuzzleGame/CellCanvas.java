...
public class CellCanvas extends JPanel implements MouseListener{
	...
	public CellCanvas(GameInterface parent, boolean editable) {
	...
	public CellCanvas(GameInterface parent, int initState, boolean editable) {
	...
	public void mouseReleased(MouseEvent e) {
		...
		} else if (e.getButton() == MouseEvent.BUTTON3 && !parent.running) {//if rightclick
